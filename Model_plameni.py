...
#описание вектора и его своиств (сложение, умножение)
class Vector(list):
...
class Point:
    ...
    def move(self, dt):
        ...
        #изменение координат (скорости и ускорения)
    def otr(self):
...
u = InteractionField(lambda p1, p2, r: (6500 * (-p1.q * p2.q) / (r ** 2 + 0.1)))#сила Кулоновского взаимодействия
for i in range(60):#количество шариков
    u.append(Vector.randvec(2,50,20)+0.1, q=random.random()-0.5)#задание случайных координат и зарядов
